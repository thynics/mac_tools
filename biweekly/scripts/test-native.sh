...
xcrun swiftc -D UI_TESTS -target "$(uname -m)-apple-macosx13.0" -framework Cocoa -framework WebKit -framework UniformTypeIdentifiers "$ROOT/Sources/main.swift" "$ROOT/tests/native.swift" -o "$TEST_APP/Contents/MacOS/Biweekly"
